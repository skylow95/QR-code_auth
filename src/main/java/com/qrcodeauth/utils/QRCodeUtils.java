...
public class QRCodeUtils {
	...
	public static BufferedImage generateQRCode() throws Exception {
		...
		try {
			...
			String plainText = lengthOTP.toString() + sessionKey.toString();
	...
	public static String decryptQRCode(InputStream inputStream) throws FormatException, ChecksumException, NotFoundException, IOException {
